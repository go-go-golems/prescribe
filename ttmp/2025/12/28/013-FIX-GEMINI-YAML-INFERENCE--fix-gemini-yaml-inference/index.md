...
RelatedFiles:
  ...
  - Path: ../012-USE-PINOCCHIO-PROFILES--use-pinocchio-profiles-for-generate-command/scripts/05-smoke-test-prescribe-generate-gemini-profile.sh
    Note: Repro script for Gemini profile inference
  - Path: ../012-USE-PINOCCHIO-PROFILES--use-pinocchio-profiles-for-generate-command/scripts/06-compare-provider-profiles-generate.sh
