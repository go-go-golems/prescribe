...
# Setup a small throwaway git repository for prescribe smoke tests.

TEST_DIR="${TEST_REPO_DIR:-/tmp/prescribe-test-repo}"
...
# Initialize git repo (force master so scripts can pass --target master consistently)
...
This is a test project for prescribe.
EOF
